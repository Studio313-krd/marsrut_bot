...
Ответы сгруппированы по разделам. Текст можно заменить целиком либо добавить фразу в начало или
конец сообщения. Картинки добавляются отправкой обычных фотографий боту — до 10 штук на ответ.
Также доступны переименование и скрытие кнопок, предпросмотр и создание новой кнопки с отдельным
сообщением. В разделе «Включение возможностей» пользовательскую функцию можно отключить целиком;
тогда исчезают её актуальные кнопки и перестают работать старые.
