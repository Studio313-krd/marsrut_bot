...
CONTENT_CATALOG: tuple[tuple[str, str, str], ...] = (
    ...
    ("system.action_error", "Не удалось выполнить действие", "system"),
    ...
    ("admin.content.edit_text", "Выбор изменения текста", "admin"),
    ("admin.content.edit_text_replace", "Ввод нового текста", "admin"),
    ("admin.content.edit_text_before", "Текст перед сообщением", "admin"),
    ("admin.content.edit_text_after", "Текст после сообщения", "admin"),
    ("admin.content.edit_images", "Добавление картинок", "admin"),
    ...
    ("admin.export.completed", "CSV-выгрузка отправлена", "admin"),
    ...
    ("requests.cancel_confirm", "Подтверждение отмены заявки", "requests"),
    ("requests.cancelled", "Заявка отменена", "requests"),
    ("privacy.about", "О проекте", "privacy"),
    ("privacy.delete_confirm", "Подтверждение удаления данных", "privacy"),
    ("privacy.deleted", "Данные пользователя удалены", "privacy"),
